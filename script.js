const apikey = window.prompt('Your api key');//fill your own api key
...
const showFilmList = (selector, name, id, poster, year) => {
  if(poster=='N/A')poster='pexels_popcorn.jpg';
	selector.innerHTML += `
        <div class='block'>
          ...
          <div class='details_container'>
            ...
            <div>
            <br>
            <button onclick="loadModal('${id}')" class="location-btn" data-toggle="modal" data-target="#movieModal">Read more</button>
            </div>
          </div>
        </div>
    `
...
const openModal = (movie) => {
  ...
  console.log(movie);
      ...
      if(image == "N/A") image = "pexels_popcorn.jpg";
  modal.innerHTML =`
